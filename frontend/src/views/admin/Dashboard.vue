...
[data-theme=.dark.] .kpi-card { background: rgba(20,20,31,0.95); border-color: rgba(255,255,255,0.05); }
...
[data-theme=.dark.] .glass-card { background: rgba(20,20,31,0.95); border-color: rgba(255,255,255,0.05); }
